...
const standardLimiter = rateLimit({
  windowMs: parseInt(RATE_LIMIT_WINDOW ?? '60000', 10),
  max: parseInt(RATE_LIMIT_MAX ?? '1000', 10),
...
const spikeLimiter = rateLimit({
  windowMs: parseInt(SPIKE_LIMIT_WINDOW ?? '10000', 10),
  max: parseInt(SPIKE_LIMIT_MAX ?? '100', 10),
